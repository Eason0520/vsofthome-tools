package com.vsofthome.tool.file;
...
public class Pdf2Word {
    ...
    private static void test() {
        try {
            String pdfFileName = "C:\\Work Office Soft\\BaiduNetdisk\\DownLoad\\aaaa.pdf";
            ...
            for (int i = 0; i < pageNumber; i++) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (resources.isImageXObject(cosName)) {
                        ...
                        File outImgFile = new File("C:\\Work Office Soft\\BaiduNetdisk\\DownLoad\\img\\" + System.currentTimeMillis() + ".jpg");
